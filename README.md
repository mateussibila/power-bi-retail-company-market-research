...
These files contain customer demographics, product information, sales data, and campaign attribution.
...
- **DAX** – creation of analytical measures and KPIs  

---

## 🎯 Outcome

This project demonstrates how marketing and customer data can be transformed into a BI solution that supports strategic insights. The dashboard enables stakeholders to evaluate campaign effectiveness, understand customer behavior, and identify key drivers behind sales performance, helping guide future marketing and product strategies.
